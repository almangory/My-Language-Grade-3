...
export default function App() {
  ...
  useEffect(() => {
    // 1. Units & Lessons
    const savedUnits = localStorage.getItem('sudanese_arabic_units_v_final_preload_v16_textbook_sync');
    if (savedUnits) {
      try {
      ...
      setUnits(INITIAL_UNITS);
      localStorage.setItem('sudanese_arabic_units_v_final_preload_v16_textbook_sync', JSON.stringify(INITIAL_UNITS));
    }
